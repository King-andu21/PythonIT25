...
# Ava fail ja loe see sisse
img = Image.open("PythonIT25/harjutus21_files/yl_pildid/181.jpg")
...
def create_thumbnails(source_dir, thumb_dir, size=(300, 300)):
    ...
    for filename in os.listdir(source_dir):
        if filename.lower().endswith(".jpg"):
            ...
            img = img.convert('L') # mustvalge pilt
            # Pisipildi loomine
...
# Kasuta funktsiooni
source_directory = 'PythonIT25/harjutus21_files/yl_pildid'
thumb_directory = 'PythonIT25/harjutus21_files/thumb/'
